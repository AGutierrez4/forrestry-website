...
export default function PricingSection() {
  return (
    <section id="pricing" className="py-24 px-6 bg-bg-light">
      <div className="max-w-[600px] mx-auto">
        ...
        <FadeUp delay={0.1}>
          <div className="bg-white border border-gray-200 rounded-2xl p-8 md:p-10 shadow-md text-center">
            {/* Price */}
            <div className="mb-8">
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-[3.5rem] font-extrabold text-text-dark">$97</span>
                <span className="text-text-body text-lg">/mo</span>
              </div>
            </div>
            ...
            <a
              ...
              className="block w-full py-4 rounded-full bg-green text-black font-bold text-lg text-center no-underline shadow-[0_0_30px_rgba(74,222,128,0.15)] hover:bg-green/90 hover:shadow-[0_0_50px_rgba(74,222,128,0.25)] transition-all"
            >
