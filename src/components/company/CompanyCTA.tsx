      ...
      <div className="relative z-10 max-w-[1100px] mx-auto text-center">
        ...
        <FadeUp delay={0.1}>
          <p className="text-muted text-lg max-w-[560px] mx-auto mb-10 leading-relaxed">
            We are looking for 100 founders to help us shape the future of Funnel Studio™.
            Once those spots are gone, the price doubles. Grab your seat, talk through
            your funnel, and let's get you launched.
          </p>
        </FadeUp>
